...
- Continued the audit-first `v2` migration by applying shared section intros, surface cards, meta grids, media link cards, text-link styling, and media frames across the design pages and case studies.
