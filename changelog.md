...
- Continued the audit-first `v2` migration by applying shared section intros, content sections, surface cards, meta grids, media link cards, text-link styling, media frames, and callout columns across the shared content pages and case studies, including broader use of `ContentSection` on the About page.
