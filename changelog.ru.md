...
- Инструмент «Deal with it» теперь плавно работает на телефонах — на тач-устройствах заморозил тяжёлые декоративные анимации, а редактор не тормозит при перетаскивании очков и движении слайдеров.
- Переделал мобильный редактор инструмента: верхние контролы больше не наезжают друг на друга, а кнопка «Create GIF» помещается на экране.
- Подчистил цвета тёмной темы — навигационные кнопки в фотоальбомах больше не выглядели белыми.

<p class="changelog-label changelog-label--improved">Улучшено</p>

- На телефонах фильтры в разделе фотографии теперь сворачиваются под переключатель, чтобы экономить место.

<p class="changelog-meta"><span class="changelog-meta__date">2026-06-13</span></p>

## Провёл полный аудит сайта с помощью Fable

<p class="changelog-label changelog-label--improved">Улучшено</p>

- Отполировал анимации по всему сайту: просмотрщик фото теперь плавно появляется, кнопки откликаются на нажатие, а декоративное движение отключается для тех, кто просит систему уменьшить анимацию.
- Фотостраницы теперь быстрее начинают загружать снимки и несут меньше встроенного кода.
- Попутно подтянул SEO-базу — sitemap, robots.txt, структурированные данные и уникальные описания фотосерий.

<p class="changelog-label changelog-label--infrastructure">Инфраструктура</p>

- Обновил Astro и Tailwind до свежих версий — в стеке не осталось ни одной известной уязвимости.
- Собрал типографику и размеры сетки в единый набор дизайн-токенов вместо магических чисел, разбросанных по страницам.
