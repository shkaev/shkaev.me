...
## Доработал русские дизайн-кейсы и унифицировал ширину текста

<p class="changelog-label changelog-label--improved">Улучшено</p>

- Полностью переписал русский кейс TrackOFF, а также продолжил дорабатывать AOSP и Cookie Manager, чтобы длинные тексты читались по-русски естественно и без буквальных кальк.
- Починил управление line-height у заголовков в callout-блоках, поправил интервалы во вступительных секциях Cookie Manager и выровнял ширину текста на Design и в кейсах по образцу страницы About.
- Переименовал русский `Чейнджлог` в `Историю изменений` и переписал русские тексты в этой панели так, чтобы они звучали как нормальный русский, а не как прямой перевод с английского.

<p class="changelog-label changelog-label--infrastructure">Инфраструктура</p>

- Закрепил правило, что при любом коммите нужно обновлять и `changelog.md`, и `changelog.ru.md` в одном changeset, а русскую версию писать естественным русским и от первого лица в единственном числе.
