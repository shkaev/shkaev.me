...
const aboutPageCopy: Record<Locale, AboutPageCopy> = {
	...
	ru: {
		...
		lead: "Я занимаюсь дизайном клиентских enterprise-продуктов для десктопа и мобильных устройств. Лучше всего у меня получается создавать осмысленный, ориентированный на человека дизайн, который помогает бизнесу достигать целей, а людям даёт ощущение ясности, заботы и вдохновения. Сейчас я отвечаю за ключевые метрики взаимодействия в продукте с десятками миллионов активных пользователей в месяц.",
		workTimeline: [
			{
