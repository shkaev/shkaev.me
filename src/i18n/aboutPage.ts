...
const aboutPageCopy: Record<Locale, AboutPageCopy> = {
	...
	ru: {
		...
		lead: "Мой общий опыт в корпоративном дизайне больше 10 лет. Специализируюсь на создании цифровых продуктов и приложений для десктопа и мобильных устройств. Проектирую интерфейсы так, чтобы цели компании и потребности пользователей дополняли друг друга. Моя сильная сторона — продуманные решения, которые помогают достигать бизнес-целей и делают работу с интерфейсом простой, логичной и естественной. Сейчас я работаю над улучшением ключевых показателей в сервисе с десятками миллионов активных пользователей в месяц.",
		workTimeline: [
			{
		...
		leadershipParagraph:
			"Лучше всего я проявляю себя как **самостоятельный специалист**, но при этом умею вести креативные инициативы в рамках бизнес-задач и эффективно работать с небольшими сильными командами. Я часто помогаю новым коллегам быстрее освоиться, участвую в их **онбординге**, регулярно делюсь опытом с другими дизайнерами и помогаю им расти в профессии.",
